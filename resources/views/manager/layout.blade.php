    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('home') }}">
                <img class="w-100" src="{{ asset('images/branding/logos/logo-w.png') }}" alt="Moviemate white logo">
            </a>
            ...
            <!-- Nav Item - Pages Collapse Menu -->
            <li class="nav-item {{ Route::is('manager.room.*') ? 'active' : '' }}">
                ...
                <div id="collapseRoom" class="collapse {{ Route::is('manager.room.*') ? 'show' : '' }}"
                    aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item {{ Route::is(['manager.room.index', 'manager.room.edit', 'manager.room.show']) ? 'active' : '' }}"
                            href="{{ route('manager.room.index') }}">View
                            Rooms</a>
                        <a class="collapse-item {{ Route::is('manager.room.create') ? 'active' : '' }}"
                            href="{{ route('manager.room.create') }}">Add
                            Rooms</a>
                    </div>
                </div>
            </li>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="{{ route('manager.room.index') }}">
                                    <i class="fas fa-users fa-sm fa-fw mr-2 text-gray-400"></i>
                                    Rooms
                                </a>
